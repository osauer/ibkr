...
func catalogExtras() map[string]CommandSpec {
	return map[string]CommandSpec{
		...
		"orders":        {Flags: flags(valueFlag("account", nil), valueFlag("since", nil), valueFlag("until", nil), valueFlag("limit", nil), valueFlag("event-limit", nil), boolFlag("json")), Subcommands: subcommands("open", "history")},
