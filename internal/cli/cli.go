...
func init() {
	commands = []Command{
		...
		{"canary", "Portfolio stress canary with concrete de-risking actions", "ibkr canary [--json]", runCanary},
		{"backtest", "Offline canary/regime backtest harness from JSONL snapshots", "ibkr backtest canary --input PATH [--json]", runBacktest},
