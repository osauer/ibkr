...
func init() {
	commands = []Command{
		...
		{"recon", "Post-trade reconciliation: broker statement flows vs the declared capital ledger", "ibkr recon show [--refresh] [--json] | ibkr recon dismiss --line ID --reason S", runRecon},
