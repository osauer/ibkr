...
func init() {
	commands = []Command{
		...
		{"settings", "Runtime platform preferences and observed read-only state", "ibkr settings show [--json] | ibkr settings set features.purge_restore.enabled=true|false|null | features.stock_protection.enabled=true|false|null", runSettings},
